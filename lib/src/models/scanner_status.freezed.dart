...
abstract class $ScannerStatusCopyWith<$Res> {
  ...
  @useResult
  $Res call({ScannerStatusType status});
}
...
class _$ScannerStatusImpl implements _ScannerStatus {
  const _$ScannerStatusImpl({required this.status});
  ...
  @override
  String toString() {
    return 'ScannerStatus(status: $status)';
  }
...
abstract class _ScannerStatus implements ScannerStatus {
  const factory _ScannerStatus(
      {required final ScannerStatusType status}) = _$ScannerStatusImpl;
